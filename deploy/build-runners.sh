...
declare -A BASE=(
  [npm]="library/node:22-alpine3.24"
  [pypi]="library/python:3.12-alpine3.24"
  [cargo]="library/rust:1-alpine3.24"
  [go]="library/golang:1.26-alpine3.24"
  [generic]="library/alpine:3.24"
  [composer]="library/php:8-alpine3.24"
  [rubygems]="library/ruby:3-alpine3.24"
  [hex]="library/elixir:1.18-alpine"
  [conan]="library/python:3.12-alpine3.24"
  [pub]="library/dart:3"
  [nuget]="mcr.microsoft.com/dotnet/sdk:10.0"
  [maven]="library/gradle:8-jdk17-alpine"
  [helm]="library/alpine:3.24"
  [oci]="library/alpine:3.24"
